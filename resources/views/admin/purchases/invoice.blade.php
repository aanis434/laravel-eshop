    ...
    <div class="container">
        <div class="row" style="margin-top: 50px;margin-bottom: 15px;">
            <div class="col-xs-5">
                <div class="col-xs-6">
                    <div class="media" style="margin-bottom:10px;">
                        ...
                        <img src="{{ asset(config('settings.logo')) }}" alt="Logo" width="100" height="50px">
                        @else
            ...
            <div class="col-xs-2" align="center">
                <h3 style="-webkit-transform: rotate(-45deg);color:red;font-size: 24px !important;"> Invoice
                </h3>
            </div>
            <div class="col-xs-5">
                <!-- <div class="col-xs-4">
                ...
                <table class="table" style="font-size: 11px !important; font-family: Calibri;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="tdNoWrap" style="text-align: right;">{{ $item->qty }}</td>
                            <td class="tdNoWrap" style="text-align: right;">BDT {{ $item->price }}</td>
                            <td class="tdNoWrap" style="text-align: right;">BDT {{ $item->total_price }}</td>
                        </tr>
                        @endforeach
                        <tr>
                            <th style="text-align:right;" colspan="3">Subtotal</th>
                            <th class="tdNoWrap" colspan="1" style="text-align: right;">BDT {{ $purchase->total_price }}</th>
                        </tr>
                        <tr>
                            <th style="text-align:right;" colspan="3">Paid Amount</th>
                            <th class="tdNoWrap" colspan="1" style="text-align: right;">BDT {{ $purchase->paid_amount }}</th>
                        </tr>
                        <tr>
                            <th style="text-align:right;" colspan="3">Paid Amount</th>
                            <th class="tdNoWrap" colspan="1" style="text-align: right;">BDT {{ $purchase->amt_to_pay }}</th>
                        </tr>
                    </tbody>
                </table>
            </div>
