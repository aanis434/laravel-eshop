        ...
        <div class="form-group">
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.menu.fields.route_name') }}
                        </th>
                        <td>
                            {{ $menu->route_name }}
                        </td>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.menu.fields.icon_or_logo') }}
                        </th>
                        <td>
                            {{ $menu->icon_or_logo }}
                        </td>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.menu.fields.menu_section') }}
                        </th>
                        <td>
                            {{ $menu->menu_section->name ?? '' }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                            {{ trans('cruds.menu.fields.parent_menu') }}
                        </th>
                        <td>
