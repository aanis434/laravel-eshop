                ...
                <table class="table" style="font-size: 11px !important; font-family: Calibri;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th class="tdNoWrap" colspan="1" style="text-align: right;">BDT {{ $order->amount }}</th>
                        </tr>
                        <tr>
                            <th style="text-align:right;" colspan="3">Discount(-)</th>
                            <th class="tdNoWrap" colspan="1" style="text-align: right;">BDT {{ $order->discount }}</th>
                        </tr>
                        <tr>
                            <th style="text-align:right;" colspan="3">Paid Amount</th>
                            <th class="tdNoWrap" colspan="1" style="text-align: right;">BDT {{ $order->total_amount }}</th>
                        </tr>
                    </tbody>
                </table>
            </div>
